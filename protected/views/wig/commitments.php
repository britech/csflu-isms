...
<table class="ink-table bordered">
    <thead>
        <tr>
            <th colspan="3">Commitments of <?php echo "{$account->employee->givenName} {$account->employee->lastName}";?></th>
        </tr>
        <tr>
            ...
            <?php foreach ($commitments as $commitment): ?>
                <tr>
                    ...
                    <?php if ($commitment->commitmentEnvironmentStatus == Commitment::STATUS_ONGOING): ?>
                        <td><?php echo ApplicationUtils::generateLink(array('wig/movementLog', 'commitment' => $commitment->id), $commitment->commitment); ?></td>
                    <?php else: ?>
                        <td>&nbsp;</td>
                    <?php endif; ?>
