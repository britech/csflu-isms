...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/manage-offices.png" style="width: 50%; text-align: center;" alt="step-6"/>
    </li>
    <li>DONE.</li>
</ol>
...
<ol>
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/manage-offices.png" style="width: 50%; text-align: center;" alt="step-1"/>
    </li>
    <li>
        Upon successful validation, the new phase data is committed in the data source and you will be redirected to the management page of the Implementing Offices.
    </li>
    <li>DONE.</li>
</ol>
...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/delete-office.png" style="width: 50%; text-align: center;" alt="step-1"/>
    </li>
    <li>
        Click the <strong>Yes</strong> button to confirm deletion of Implementing Office entry
    </li>
    <li>
        Upon successful validation, the phase data is removed in the data source and you will be redirected to the management page of the Implementing Offices.
    </li>
    <li>DONE.</li>
</ol>
<span style="display: block; margin-bottom: 50px;">
