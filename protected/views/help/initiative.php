...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/create-step-1.png" style=";" alt="step-3"/>
    </li>
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/create-step-2.png" style=";" alt="step-4"/>
    </li>
    <li>
...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/update-initiative.png" style=";" alt="step-6"/>
    </li>
...
<?php $this->renderPartial('help/_initiative-movement');
