...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/activity-overview-ongoing.png" style=";" alt="step-4"/>
    </li>
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/movement.png" style=";" alt="step-4"/>
    </li>
    <li>
