...
<ol>
    <li>
        ...
        <br/>
        If you are in the View page of selected Unit Breakthrough, proceed to <?php echo ApplicationUtils::generateLink('#malign-5', 'Step 5') ?>
    </li>
    <li>
        <a name="malign-2"></a>
    ...
    <li>
        <a name="malign-3"></a>
        You will be then redirected to the View page of the selected Strategy Map. Click the <strong>Manage Unit Breakthrough</strong> link.
        <br/>
        <img src="protected/views/help/images/map/create-step-3.png" alt="step-3"/>
    </li>
    <li>
        Upon clicking the <strong>Manage Unit Breakthrough</strong> link, you will be redirected to the directory listing of Unit Breakthroughs. 
        <br/>
    ...
    <li>
        You will be redirected to the management page of the Unit Breakthrough's Strategy Alignments.
        <br/>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/manage-alignments.png" alt="step-6"/>
    </li>
    <li>DONE.</li>
</ol>
...
<ol>
    <li>
        ...
        <br/>
        <strong>Important Note:&nbsp;</strong>You can choose between strategic objectives and measure profiles to insert as Strategy Alignments for the selected Unit Breakthrough.
        <br/>
        <strong>Tip:&nbsp;</strong>You can select <strong>TWO or MORE</strong> strategic objectives and/or measure profiles.
        <br/>
        <img src="protected/views/help/images/ubt/manage-alignments.png" alt="step-1"/>
    </li>
    <li>
...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/ubt/delete-alignment.png" alt="step-1"/>
    </li>
    <li>
