...
<span style="display: block; text-align: center;">
    ...
    <img src="protected/views/help/images/initiative/activity-lifecycle.png" style="width: 50%; text-align: center;" alt="life-cycle"/>    
</span>
<ol>
    <li>
...
<ol>
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/dashboard-step-3.png" style="width: 50%; text-align: center;" alt="step-1"/>
    </li>
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/activity-overview-ongoing.png" style="width: 50%; text-align: center;" alt="step-2"/>
    </li>
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/activity-pending.png" style="width: 50%; text-align: center;" alt="step-3"/>
    </li>
    <li>
...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/activity-overview-pending.png" style="width: 50%; text-align: center;" alt="step-2"/>
    </li>
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/activity-ongoing.png" style="width: 50%; text-align: center;" alt="step-3"/>
    </li>
    <li>
        Click the <strong>Yes</strong> button to confirm the status update.
    </li>
...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/activity-finished.png" style="width: 50%; text-align: center;" alt="step-3"/>
    </li>
    <li>
...
<ol>
    ...
    <li>
        ...
        <br/>
        <img src="protected/views/help/images/initiative/activity-discontinued.png" style="width: 50%; text-align: center;" alt="step-3"/>
    </li>
    <li>
